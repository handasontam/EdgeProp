...
class UnsupervisedMiniBatchTrainer(object):
    ...
    def train(self):
        ...
        for name, classifier in classifiers.items():
            classifier.fit(X=dgi_X_train, y=y_train)
            pred = classifier.predict(dgi_X_test)
            ...
            print('DGI -', name, '(precision) : ', val_macro_precision)
            print('DGI -', name, '(recall) : ', val_macro_recall)
            print('DGI -', name, '(macro f1) : ', val_macro_f1)
            print('DGI -', name, '(micro f1) : ', val_micro_f1)
        ...
        for name, classifier in classifiers.items():
            ...
            val_micro_f1 = micro_f1(pred, y_test)
            val_macro_f1 = macro_f1(pred, y_test)
            print(name, '(precision) : ', val_macro_precision)
            print(name, '(recall) : ', val_macro_recall)
            print(name, '(macro f1) : ', val_macro_f1)
            print(name, '(micro f1) : ', val_micro_f1)
